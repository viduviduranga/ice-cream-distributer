  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Assign User Property</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Assign user Property</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Assign User Property</h3>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
							<form method="post" action="<?php echo base_url('portal/users/assignproperty'); ?>">
...
for($i = 0 ; $i < count($_SESSION['user_nic_list']) ; $i++) 
			 {                                                  
echo '<option value="'.$_SESSION['user_role_list'][$i].'">'.$_SESSION['user_nic_list'][$i].' &nbsp; - &nbsp; '.$_SESSION['user_name_list'][$i].'</option>';
			 }
              ...
              <div class="col-md-6">
				...
				<label>User Name</label>
                        <input type="text" name="user_name" id="user_name" class="form-control" placeholder="" disabled>
								...
								<br><br><br><br>
											<div  align='right'>
											<button type="submit" value="assign_role" name="assign_role"  class="btn btn-primary">Assign </button>
											</div>
                </div>
                <!-- /.form-group -->
              </div>
