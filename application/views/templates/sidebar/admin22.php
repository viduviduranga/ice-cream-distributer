      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url();?>portal/roomassigns/assign/holidaystep1" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Season Rates</p>
                </a>
              </li>
					...
					<li class="nav-item">
            <a href="portal/booking/step/1" onClick="Element.requestFullscreen" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Booking
                <i class="fas fa-angle-left right"></i>
